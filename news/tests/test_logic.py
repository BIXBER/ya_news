...
class TestCommentCreation(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url = reverse('news:detail', kwargs={'pk': cls.news.id})
...
class TestCommentEditDelete(TestCase):
    ...
    def setUpTestData(cls):
        cls.news = News.objects.create(title='Заголовок', text='Текст')
        news_url = reverse('news:detail', kwargs={'pk': cls.news.id})
        ...
        cls.edit_url = reverse('news:edit', kwargs={'pk': cls.comment.id})
        cls.delete_url = reverse('news:delete', kwargs={'pk': cls.comment.id})
